...
LABEL MAINTAINER="Dilan Kalpa De Silva <dilan@ceylonlinux.com>"

ENV TZ=Asia/Colombo

RUN ln -snf /usr/share/zoneinfo/$TZ /etc/localtime && echo $TZ > /etc/timezone

ENV http_proxy http://192.168.0.254:3128
ENV https_proxy http://192.168.0.254:3128

RUN apt-get update && apt-get -y upgrade
RUN apt-get install -y software-properties-common
RUN add-apt-repository ppa:ondrej/php
RUN apt-get -y install apache2 curl rsync git openssh-client php7.4 php7.4-zip php7.4-curl libapache2-mod-php7.4 php7.4-mysql php7.4-mbstring php7.4-json php7.4-gd php7.4-xml php7.4-soap
